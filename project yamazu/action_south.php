...
<td><a href="view_Deatils_south.php?id=<?php echo $row['ID']; ?>"><button style="background-color:black;">View</a></button></td>
<td><a href="adUpdate.php"><button style="background-color:black;">Update</a></button></td>
<td><a href="userDelete_south.php?id=<?php echo $row['ID']; ?>"><button style="background-color:black;">delete</a></button></td>
</tr>
<?php
}
echo "</table>";
